var Reflex = {
    ...
    _renderWidget: function(_presentationData) {
        var widgetHTML = '';
        widgetHTML += '<form>';
        widgetHTML +=   '<h3>' + _presentationData.userPrompt + '</h3>';
        widgetHTML +=   '<textarea class="feedback-text"></textarea>';
        widgetHTML +=   '<div class="button-container"><a class="send-button">' + _presentationData.sendButtonText + '</a></div>';
        widgetHTML += '</form>';
